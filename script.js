...
'#quote-copy':'Estimates are based on global market standards. A 30% deposit is required to initiate any engagement.'},es:{
  ...
  selectors:{
    ...
    :'paths',:'certificaciones',

    // ── Contact ──
    '#services-tag':'[ SERVICIOS ]','#services-heading':'Servicios','#services-copy':'Proyectos remotos, entregables claros. La llamada de alcance es gratuita — sin compromiso.',:'Desde $3,000 USD',:'Desde $5,000 USD',:'Evaluación de Vulnerabilidades','#svc-va-desc':'Escaneo automatizado + manual de tu superficie de ataque con hallazgos validados y un reporte de remediación priorizado. Punto de entrada de menor costo antes de un pentest completo.',:'Evaluación de Seguridad AI / LLM','#svc-ai-desc':'Identifica riesgos de prompt injection, fuga de datos y manipulación de modelos en tus aplicaciones con IA antes de que lleguen a producción.',:'[ PRECIOS ]','#quote-heading':'Conoce el precio en 60 segundos','#quote-copy':'Completa los detalles para obtener un rango de precio al instante. Se enviará una propuesta formal después de la llamada de alcance.','#ql-service':'Servicio','#ql-scope':'Tamaño del alcance','#ql-complexity':'Complejidad','#ql-tbox':'Tipo de testing',:'Sin acceso previo',:'Credenciales parciales',:'Acceso completo + código','#ql-addons':'Complementos',:'Engagement presencial +20%',:'Rango estimado',:'Este es un estimado automático. El precio final puede variar tras el alcance. Todo engagement requiere un acuerdo de autorización firmado antes de iniciar.','#contact .section-tag':'[ CONTACTO ]',
    ...
    // ── Footer ──
    'footer a[href="#main"]':'↑ Volver arriba',:'↻ actualiza cada 24h',
