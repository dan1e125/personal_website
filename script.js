...
'#svc-web-desc':'Full manual assessment of web apps, APIs and authentication systems. OWASP-aligned methodology.',
'#svc-web-price':'From ,000 USD',
'#svc-web-btn':'Get a quote',
'#svc-ad-title':'Active Directory Pentest',
'#svc-ad-desc':'AD enumeration, Kerberoasting, privilege escalation, domain compromise and persistence.',
'#svc-ad-price':'From ,000 USD',
'#svc-ad-btn':'Get a quote',
'#svc-wifi-title':'Wi-Fi Assessment',
'#svc-wifi-desc':'Wireless network security: rogue AP, WPA2/3 attacks, client-side exploitation and evil-twin.',
'#svc-wifi-price':'From ,000 USD',


'#svc-va-desc':'Automated + manual scan of your infrastructure with risk-classified findings and remediation guidance.',
'#svc-va-price':'From 00 USD',


'#svc-rt-desc':'Full adversary simulation: phishing, physical access, lateral movement and data exfiltration.',
'#svc-rt-price':'From ,000 USD',

'#svc-soc-title':'SOC Analysis',
'#svc-soc-desc':'SIEM deployment, alert triage, log analysis, threat hunting and incident escalation procedures.',
'#svc-soc-price':'From ,500 USD / mo',
'#svc-soc-btn':'Get a quote',

'#svc-rem-desc':'Post-breach support: root-cause analysis, containment, hardening and re-testing of critical findings.',
'#svc-rem-price':'From 0 USD / hr',

'#quote-tag':'[ PRICING ]',
'#quote-heading':'Get an instant quote',
'#quote-copy':'Estimates are based on global market standards. A 30% deposit is required to initiate any engagement.',
'#q-service-label':'Service',
'#q-scope-label':'Scope size',
'#q-complexity-label':'Complexity',
'#q-addons-label':'Add-ons',
'#q-addon-urgent-label':'Urgent (< 2 weeks)',
'#q-addon-executive-label':'Executive report',
'#q-addon-onsite-label':'On-site required',
'#q-addon-retest-label':'Free retest',
'#q-contact-alt':'Prefer to talk first?',
'#q-contact-btn':'Contact me',
'#q-disclaimer':'All prices are in USD. Final price depends on scope, findings and engagement complexity. Estimates are not binding until a Statement of Work is signed.'
},es:{
  ...
  selectors:{
    ...
    // ── Hero ──
    '.hero-copy .section-tag':'[ OPERADOR ACTIVO ]','.identity-role':'Pentester',
    ...
    '#experience .section-heading h3':'Contexto de habilidades y trayectoria de formacion',
    ...
    // ── HTB Lab Coverage ──
    '#htb-coverage .section-tag':'[ COBERTURA LABORATORIOS HTB ]',
    '#htb-coverage h3':'Cobertura de Laboratorios HackTheBox',
    '#htb-coverage .section-copy':'12 paths completados que cubren toda la superficie de ataque y disciplinas defensivas.',
    ...
    '#about article:nth-child(1) p:nth-of-type(2)':'Cada evaluación la abordo con la perspectiva de quien ha desarrollado software — entender cómo se introducen las vulnerabilidades facilita encontrarlas y proponer correcciones que realmente funcionen. Mi formación cubre el espectro completo: explotación web, ataques a Active Directory, pivoting en redes, escalada de privilegios, explotación binaria y respuesta a incidentes — abarcando los ángulos ofensivo y defensivo.',
    ...
    '.transcript-featured > span':'El transcript oficial de HTB Academy — evidencia verificable de todos los paths y labs completados.',
    
    
    
    
    '.transcript-mini-stats div:nth-child(1) span':'objetivos','.transcript-mini-stats div:nth-child(2) span':'paths','.transcript-mini-stats div:nth-child(3) span':'ranking','.transcript-mini-stats div:nth-child(4) span':'certificaciones','.transcript-download-btn':'↓ Descargar Transcripcion',

    // ── Contact ──
    '#svc-va-title':'Evaluación de Vulnerabilidades','#svc-va-desc':'Escaneo automatizado + manual de tu superficie de ataque con hallazgos validados y un reporte de remediación priorizado. Punto de entrada de menor costo antes de un pentest completo.','#svc-va-price':'Desde $500 USD','#svc-va-btn':'Solicitar cotización','#svc-ai-title':'Evaluación de Seguridad AI / LLM','#svc-ai-desc':'Identifica riesgos de prompt injection, fuga de datos y manipulación de modelos en tus aplicaciones con IA antes de que lleguen a producción.','#svc-ai-price':'Desde $2,000 USD','#svc-ai-btn':'Solicitar cotización','#contact .section-tag':'[ CONTACTO ]',
    '#contact h3':'Contáctame',
    '.contact-intro':'Disponible para proyectos remotos en todo el mundo. Respondo en menos de 24h. La llamada de alcance es gratuita, sin compromiso.',
    ...
    '#contact .social-grid .social-link:nth-child(3) .social-copy span':'Perfil profesional y red de contactos',
    ...
    // ── Footer ──
    'footer a[href="#main"]':'↑ Volver arriba','#cve-section-tag':'[ CVE DEL DÍA ]','#cve-refresh-hint':'↻ actualiza cada 24h',
...
(function () {
  ...
  var PRICES = {
    pentest_web: { name:'Web App Pentest',  base:[3000,6000], scope:{small:1.0,medium:1.55,large:2.3}, cplx:{low:1.0,medium:1.45,high:2.0} },
    pentest_ad:     { name:'Active Directory',    base:[5000,9500], scope:{small:1.0,medium:1.4, large:2.0}, cplx:{low:1.0,medium:1.35,high:1.85} },
    vuln_assessment: { name:'Vuln Assessment',      base:[500,1500],   scope:{small:1.0,medium:1.3, large:1.8}, cplx:{low:1.0,medium:1.2, high:1.5}  },
    pentest_ai:      { name:'AI / LLM Assessment', base:[2000,4500],  scope:{small:1.0,medium:1.4, large:2.0}, cplx:{low:1.0,medium:1.35,high:1.8}  }
  };
  var ADDONS = { urgent:{label:'Rush',pct:.25}, executive:{label:'Exec.rpt',pct:.15}, onsite:{label:'On-site',pct:.20}, retest:{label:'Re-test',pct:.10} };
  ...
  function recalc() {
    ...
    var svc = svcBtn.dataset.svc, scope = scopeBtn.dataset.scope, cplx = cplxBtn.dataset.cplx;
    var p = PRICES[svc]; if (!p) return;
    var mn = p.base[0] * (p.scope[scope]||1) * (p.cplx[cplx]||1);
    var mx = p.base[1] * (p.scope[scope]||1) * (p.cplx[cplx]||1);
