...
'#svc-net-desc':'External and internal network assessment. Port scanning, service exploitation, lateral movement.',
'#svc-net-price':'From ,500 USD',
'#svc-net-btn':'Get a quote',
...
'#q-disclaimer':'All prices are in USD. Final price depends on scope, findings and engagement complexity. Estimates are not binding until a Statement of Work is signed.'
  ...
  metaDescription:'Daniel Ordonez Arango — Penetration Tester con paths CPTS, CDSA, CJCA y CWEE completados. Seguridad web, redes y Active Directory. HTB Top 1%, 658 objetivos comprometidos.',
  ...
  selectors:{
    ...
    '.hero-copy .lead':'Mi trabajo cubre el ciclo completo de reconocimiento, explotación e informes claros.',
    ...
    '.contact-intro':'Si buscas un especialista en pentesting que comunique hallazgos con claridad y trabaje con contexto practico, puedes contactarme por los siguientes canales.',
...
(function () {
  ...
  function recalc() {
    ...
    if (el('qc-bar')) el('qc-bar').style.width = Math.min(92,Math.max(8,((mn-800)/35000)*100)).toFixed(1)+'%';
