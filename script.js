...
'.avail-text':'Available for engagements','.terminal-label':'daniel@portfolio:~$ ./profile_scan','.status-grid div:nth-child(1) span':'Status','.status-grid div:nth-child(1) strong':'ACTIVE','.status-grid div:nth-child(2) span':'Focus','.status-grid div:nth-child(2) strong':'PENTEST','.status-grid div:nth-child(3) span':'Mode','.status-grid div:nth-child(3) strong':'REMOTE','.status-grid div:nth-child(4) span':'Coverage','.status-grid div:nth-child(4) strong':'WEB / NET / SYS','.status-grid div:nth-child(5) span':'Availability','.status-grid div:nth-child(5) strong':'OPEN','.status-grid div:nth-child(6) span':'Languages','.status-grid div:nth-child(6) strong':'EN / ES','#experience .section-heading .section-tag':'[ PROFESSIONAL EXPERIENCE ]','#experience .section-heading h3':'Background & Training','#experience .timeline-item:nth-child(1) .role':'Full-Stack Developer & Security Specialist · Ongoing','#experience .timeline-item:nth-child(1) .detail-list li:nth-child(1)':'Web application development using PHP, JavaScript and Node.js with security integrated from the start.','#experience .timeline-item:nth-child(1) .detail-list li:nth-child(2)':'Network and application security — hardening, vulnerability assessments and secure architecture decisions.','#experience .timeline-item:nth-child(1) .detail-list li:nth-child(3)':'Linux server administration — deployment, configuration and maintenance of production environments.','#experience .timeline-item:nth-child(2) .role':'Offensive & Defensive Security Training · 2025','#experience .timeline-item:nth-child(2) .detail-list li:nth-child(1)':'Completed full penetration testing methodology covering web apps, networks and Active Directory through the CPTS path.','#experience .timeline-item:nth-child(2) .detail-list li:nth-child(2)':'Covered advanced server-side and client-side web exploitation techniques through the CWEE path.','#experience .timeline-item:nth-child(2) .detail-list li:nth-child(3)':'Trained in SIEM monitoring, DFIR and incident response using Splunk, Elastic Stack and Suricata (CDSA path).','#experience .timeline-item:nth-child(2) .detail-list li:nth-child(4)':'Trained in professional reporting — translating technical findings into actionable business impact.','#certifications-tag':'[ CERTIFICATIONS ]','#certifications-heading':'Training & Certifications','#cert-transcript-link':'View HTB Transcript →','#certifications .training-section:nth-of-type(1) .section-tag':'[ HTB Job Role & Skills Paths Completed ]','.path-card:nth-child(1) span:last-child':'Web recon, authentication flaws, API exploitation and OWASP-aligned methodology.','.path-card:nth-child(2) span:last-child':'End-to-end methodology: recon, exploitation, post-exploitation, lateral movement and reporting.','.path-card:nth-child(3) span:last-child':'Threat detection, DFIR, incident response and SOC analysis procedures.','.path-card:nth-child(1) strong':'Web Penetration Tester','.path-card:nth-child(2) strong':'Penetration Tester','.path-card:nth-child(3) strong':'SOC Analyst','.path-card:nth-child(4) strong':'Active Directory Enumeration','.path-card:nth-child(4) span:last-child':'In-depth AD enumeration techniques, tools and attack surface mapping. Hard difficulty path.','.path-card:nth-child(5) strong':'Information Security Foundations','.path-card:nth-child(5) span:last-child':'Core InfoSec concepts: networking, cryptography, pentesting methodology and career foundations.','.path-card:nth-child(6) strong':'Operating System Fundamentals','.path-card:nth-child(6) span:last-child':'Windows and Linux internals, administration and hardening in line with security best practices.','.path-card:nth-child(7) strong':'Local Privilege Escalation','.path-card:nth-child(7) span:last-child':'Manual and tool-assisted privilege escalation techniques on Windows and Linux systems.','.path-card:nth-child(8) strong':'Intro to Binary Exploitation','.path-card:nth-child(8) span:last-child':'Buffer overflows, shellcode and exploit scripting. Hard difficulty path.','.path-card:nth-child(9) strong':'Junior Cybersecurity Analyst','.path-card:nth-child(9) span:last-child':'SOC operations, network security fundamentals, SIEM monitoring and incident handling.','#cert-external-label':'External cybersecurity studies','#cert-ibm-title':'IBM Cybersecurity Analyst Professional Certificate','#cert-ibm-sub':'Professional Certificate · V2 · Credly verified','#cert-google-title':'Google Cybersecurity Professional Certificate','#cert-google-sub':'Professional Certificate · V2 · Credly verified','#cert-credly-link':'Verify on Credly →','#about-tag':'[ ABOUT ]','#about-p1':'I started as a full-stack developer. That background changes how I test — I know how applications are built, which means I know exactly where developers leave gaps.','#about-p2':"My training covers the full offensive attack surface: web exploitation, Active Directory attacks, network pivoting, privilege escalation and incident response. I don't just find vulnerabilities — I explain why they exist, what a real attacker would do with them, and how to fix them correctly.",'#about-p3':'I work remotely with startups and SMBs across Latin America, the US and Europe. Fixed-price engagements, bilingual delivery, and a free re-test to confirm your fixes actually hold.','#about-hl1-title':'Remote-first','#about-hl1-desc':'Available for engagements worldwide — no travel overhead','#about-hl2-title':'Bilingual','#about-hl2-desc':'Engagements and reports in English and Spanish','#about-hl3-title':'Fixed price','#about-hl3-desc':'Agreed in writing before any work begins — no surprises','#about-hl4-title':'Free re-test','#about-hl4-desc':'Included with every engagement to verify fixes hold','#about-hl5-title':'NDA before day one','#about-hl5-desc':'Signed prior to any access, scope or technical discussion','#cs-tag':'[ CASE STUDIES ]','#case-studies-heading':'Redacted Assessment Reports','#cs-sub':'Real engagements — findings, methodology and remediation guidance, redacted for confidentiality.','#cs1-type':'Web Application · Black-Box','#cs1-crit':'1 Critical','#cs1-high':'3 High','#cs1-total':'10 findings','#cs1-title':'SEO Injection & Malware Discovery','#cs1-desc':'Production WordPress site silently compromised. Malicious PHP served gambling content exclusively to Google crawlers — invisible to human visitors — exploiting the client\'s domain authority to rank illegal content on Search.','#cs1-f1':'PHP backdoor with Google FCrDNS verification serving casino content to Googlebot — active and undetected on production','#cs1-f2':'Remote content injection via cURL from attacker-controlled Cloudflare Pages subdomain','#cs1-f3':'Unrestricted file write on web root — persistent attacker-controlled server-side execution','#cs1-link':'View redacted report →','#cs2-type':'WordPress · Static Analysis','#cs2-crit':'5 Critical','#cs2-high':'6 High','#cs2-total':'20 findings','#cs2-title':'WordPress Intranet — Static Code Analysis','#cs2-desc':'Full source code review of a private WordPress intranet. 20 vulnerabilities across the codebase, server configuration, and third-party integrations — including hardcoded credentials for external HR and payment systems.','#cs2-f1':'Hardcoded API credentials for HR and payment systems in source code (CVSS 9.8)','#cs2-f2':'JWT plugin active with secret key undefined — full authentication bypass vector (CVSS 9.3)','#cs2-f3':'Stored XSS via unescaped third-party API output · Path traversal in file download handler','#cs2-link':'View redacted report →','.topnav a[href="#case-studies"]':'Case Studies','#contact h3':'Get in touch','#cg-profiles':'Online profiles','.contact-intro':'Available for remote engagements worldwide. Response within 24h. The first call costs nothing — we define scope, timeline and fit before any agreement.','.contact-card-phone-title':'Phone','.contact-card-phone-copy':'Direct call — fastest response','.cg-li-title':'LinkedIn','.cg-li-desc':'Professional profile and networking','.cg-gh-title':'GitHub','.cg-gh-desc':'Code, projects and technical footprint','.contact-form-card .section-tag':'[ SEND A MESSAGE ]','.cf-heading':'Direct message','label[for="cf-name"]':'Name','label[for="cf-email"]':'Email','label[for="cf-message"]':'Message','.cf-btn-text':'Send message','.topnav a[href="#services"]':'Services','.topnav a[href="#quote"]':'Pricing','#process-heading':'From first contact to final report','#process .section-heading .section-tag':'[ HOW IT WORKS ]','#process-copy':'A straightforward engagement cycle designed to minimize disruption and maximize actionable output. Most engagements complete in 1–2 weeks from scoping call to final report.','#process-step1-title':'Scoping Call','#process-step1-desc':'Free 30-minute call to understand your environment, define targets and agree on rules of engagement. No commitment required.','#process-step2-title':'Proposal & NDA','#process-step2-desc':'You receive a written proposal with scope, timeline, methodology and fixed price. NDA signed before any work begins.','#process-step3-title':'Engagement','#process-step3-desc':'Active testing phase. You get progress updates throughout. Any critical findings are reported immediately — no waiting for the final report.','#process-step4-title':'Report & Re-test','#process-step4-desc':'Detailed PDF report with risk ratings, proof-of-concept and remediation steps. Free re-test included to verify fixes were applied correctly.','.topnav a[href="#process"]':'Process','#services-tag':'[ SERVICES ]','#services-heading':'Services','#services-copy':'Remote engagements, clear deliverables, and findings your team can act on.','#svc-web-title':'Web Application Pentest','#svc-web-desc':'Find exploitable vulnerabilities in your app before a breach does. OWASP-aligned manual testing with a written report your team can act on immediately.','#svc-ad-title':'Active Directory Pentest','#svc-ad-desc':'Identify attack paths through your internal network before a threat actor does. BloodHound mapping, credential attacks, and a clear remediation roadmap.','#svc-va-title':'AI / LLM Security Assessment','#svc-net-title':'Network Pentest','#svc-va-desc':'Red-team your AI and LLM integrations against the OWASP LLM Top 10. Covers prompt injection, jailbreaks, model output attacks, data pipeline vulnerabilities and AI abuse vectors.','#svc-net-desc':'Identify exposed services, misconfigurations, lateral movement paths and exploitable vulnerabilities across your internal and external network.','#quote-tag':'[ PRICING ]','#see-pricing-cta':'See pricing →',
  ...
  selectors:{
    ...
    // ── Contact ──
    '#services-tag':'[ SERVICIOS ]','#services-heading':'Servicios','#services-copy':'Proyectos remotos, entregables claros, hallazgos que tu equipo puede corregir.','#svc-web-title':'Pentest de Aplicación Web','#svc-web-desc':'Encuentra vulnerabilidades explotables en tu aplicación antes de una brecha. Testing manual alineado con OWASP con un reporte que tu equipo puede ejecutar de inmediato.','#svc-ad-title':'Pentest de Active Directory','#svc-ad-desc':'Identifica rutas de ataque en tu red interna antes que un actor de amenaza. Mapeo con BloodHound, simulación de ataques de credenciales y una hoja de ruta de remediación clara.','#svc-va-title':'Evaluación de Seguridad AI / LLM','#svc-net-title':'Pentest de Redes','#svc-va-desc':'Red-team de tus integraciones de IA y LLM contra el OWASP LLM Top 10. Cubre prompt injection, jailbreaks, ataques de salida del modelo, vulnerabilidades en el pipeline de datos y vectores de abuso de IA.','#svc-net-desc':'Identifica servicios expuestos, configuraciones incorrectas, rutas de movimiento lateral y vulnerabilidades explotables en tu red interna y externa.','.service-cta':'Solicitar cotización →','#tbox-info-black-title':'Caja negra','#tbox-info-black-desc':'Sin conocimiento previo del objetivo. Simula un atacante externo real. Ideal para evaluar tus defensas desde una perspectiva adversarial.','#tbox-info-black-rec':'✓ Más común','#tbox-info-grey-title':'Caja gris','#tbox-info-grey-desc':'Se proporcionan credenciales o contexto parcial. Simula una cuenta comprometida o amenaza interna. Mejor relación cobertura/costo.','#tbox-info-grey-rec':'✓ Recomendado','#tbox-info-white-title':'Caja blanca','#tbox-info-white-desc':'Acceso completo + código fuente. Máxima profundidad y cobertura. Ideal para auditorías exhaustivas o cuando las normativas lo exigen.','#tbox-info-white-rec':'✓ Más exhaustivo','#qc-tbox-help-btn':'?',
    ...
    en: {
      ...
      items: [
        ...
        { q: 'How long does a penetration test take?',
          a: 'Most engagements complete in 1–2 weeks from the scoping call to the final report. An AI / LLM security assessment for focused integrations can be delivered in 3–5 days. Timeline is agreed and fixed in the written proposal before any work begins.' },
    ...
    es: {
      ...
      items: [
        ...
        { q: '¿Cuánto tiempo tarda un pentest?',
          a: 'La mayoría de los proyectos se completan en 1–2 semanas desde la llamada de alcance hasta el informe final. Una evaluación de seguridad AI / LLM para integraciones puntuales puede entregarse en 3–5 días. El cronograma se acuerda y fija por escrito antes de comenzar.' },
