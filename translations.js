...
const translations = {
  en: {
    ...
    selectors: {
      ...
      '.hero-copy .lead': 'I find the vulnerabilities in your systems before someone exploits them. Structured methodology, written deliverables, and a report your team can act on — from scoping call to final report in under two weeks.',
  ...
  es: {
    ...
    selectors: {
      ...
      '.hero-copy .lead': 'Encuentro las vulnerabilidades en tus sistemas antes de que alguien las explote. Metodología estructurada, entregables escritos y un reporte que tu equipo puede ejecutar — de la llamada inicial al reporte final en menos de dos semanas.',
