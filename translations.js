...
const translations = {
  en: {
    ...
    selectors: {
      ...
      '#cert-htb-senior-web-meta': 'Aligns with Web App pentest service',
  ...
  es: {
    ...
    selectors: {
      ...
      '#cert-htb-senior-web': 'Senior Web Penetration Tester',
      '#cert-htb-senior-web-meta': 'Alineado con el servicio de pentest Web App',
      '.cert-status--progress': 'En progreso',
      '#cert-htb-ad': 'Active Directory Pentesting Expert',
